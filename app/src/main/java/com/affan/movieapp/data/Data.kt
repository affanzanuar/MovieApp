...
object Data {
    ...
    val itemInTheaters : ArrayList<MoviesOrSeries> = arrayListOf(
        MoviesOrSeries(
            ...
            R.drawable.backdrop_the_invitation,
            "Horror, Thriller",
            "6.4",
            true,
        ...
        MoviesOrSeries(
            ...
            R.drawable.backdrop_bullet_train,
        ...
        MoviesOrSeries(
            ...
            R.drawable.backdrop_top_gun_maverick,
            "Action, Drama",
            "8.4",
            true,
        ...
        MoviesOrSeries(
            ...
            R.drawable.backdrop_dragon_ball_super,
            "Animasi",
            "8.0",
            false,
        ...
        MoviesOrSeries(
            ...
            R.drawable.backdrop_honk_for_jesus,
            "Komedi",
            "4.8",
            false,
        ...
        MoviesOrSeries(
            ...
            R.drawable.backdrop_dc_league_of_super_pets,
            "Animasi",
            "7.6",
            false,
        ...
        MoviesOrSeries(
            ...
            R.drawable.backdrop_three_thousand_years_of_longing,
            "Fantasi, Drama, Percintaan",
            "7.0",
            true,
        ...
        MoviesOrSeries(
            ...
            R.drawable.backdrop_minions_the_rise_of_gru,
            "Animasi",
            "7.7",
            false,
            "Seorang penggemar kelompok penjahat super yang dikenal sebagai Vicious 6, Gru menyusun rencana untuk menjadi cukup jahat untuk bergabung dengan mereka, dengan dukungan pengikutnya, para Minion."
        ...
        MoviesOrSeries(
            ...
            R.drawable.backdrop_thor_love_and_thunder,
        ...
        MoviesOrSeries(
            ...
            R.drawable.backdrop_where_the_crawdads_sing,
        ...
        MoviesOrSeries(
            ...
            R.drawable.backdrop_gigi_and_nate,
            "Drama",
            "6.0",
            false,
        ...
        MoviesOrSeries(
            ...
            R.drawable.backdrop_orphan_first_kill,
            " Horror, Thriller ",
            "7.1",
            true,
            "Setelah melarikan diri dari fasilitas psikiatri Estonia, Leena Klammer melakukan perjalanan ke Amerika dengan menyamar sebagai Esther, putri hilang dari keluarga kaya. Tetapi ketika topengnya mulai terlepas, dia dihadapkan pada seorang ibu yang akan melindungi keluarganya dari “anak” pembunuh dengan cara apa pun."
        )
    )
    ...
    val itemMostPopularMovies : ArrayList<MoviesOrSeries> = arrayListOf(
        ...
        MoviesOrSeries(
            ...
            "8.2",
            false,
            "Selama 1980-an, seorang pelawak berdiri gagal didorong gila dan beralih ke kehidupan kejahatan dan kekacauan di Kota Gotham sambil menjadi tokoh kejahatan psikopat terkenal."
        )
    )
